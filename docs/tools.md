...
| `get_skill` | Fetch a bundled procedure by name — the two upload flows, `mywhoosh-activity-import`, `coaching` or `nutrition` — so a model asked to "use the mywhoosh-upload skill" can retrieve it. |
